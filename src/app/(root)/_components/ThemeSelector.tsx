  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-48 group relative flex items-center gap-2 px-4 py-2.5 bg-elevated/80 hover:bg-elevated 
        rounded-lg transition-all duration-200 border border-border/60 hover:border-border"
      >
        ...
        <span className="text-foreground/80 min-w-[80px] text-left group-hover:text-foreground transition-colors">
          {currentTheme?.label}
        </span>
        ...
        <div
          className="relative w-4 h-4 rounded-full border border-border group-hover:border-border transition-colors"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[240px] bg-elevated/95 
            backdrop-blur-xl rounded-xl border border-border shadow-2xl py-2 z-50"
          >
            <div className="px-2 pb-2 mb-2 border-b border-border/60">
            ...
            {THEMES.map((t, index) => (
              <motion.button
                ...
                className={`
                relative group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-elevated/80 transition-all duration-200
                ${theme === t.id ? "bg-accent/10 text-accent" : "text-foreground/80"}
              `}
              ...
              group-hover:opacity-100 transition-opacity"
                ...
                ${theme === t.id ? "bg-accent/10 text-accent" : "bg-elevated/50 text-muted-foreground"}
