...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-3 px-4 py-2.5 bg-elevated/80 
      rounded-lg transition-all 
       duration-200 border border-border/60 hover:border-border
  ...
  <div className="size-6 rounded-md bg-elevated/50 p-0.5 group-hover:scale-110 transition-transform">
          <Image
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-64 bg-elevated/95 backdrop-blur-xl
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      ${language === lang.id ? "bg-accent/10 text-accent" : "text-foreground/80"}
                      ${isLocked ? "opacity-50" : "hover:bg-elevated/80"}
                    `}
                    ...
                    >
                      ...
                      <div
                        className={`
                         ...
                         ${language === lang.id ? "bg-accent/10" : "bg-elevated/50"}
                       `}
                      >
                        <div
                          className="absolute inset-0 bg-gradient-to-br from-accent/10 to-purple-500/10 rounded-lg 
                        opacity-0 group-hover:opacity-100 transition-opacity"
                        />
                        <Image
                          width={24}
